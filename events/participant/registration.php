...
//.
if (!isset($_POST['username'], $_POST['nume'], $_POST['prenume'], $_POST['password'], $_POST['email'], $_POST['telefon'])) {
...
if (empty($_POST['username'] || $_POST['nume']) || empty($_POST['prenume']) || empty($_POST['password']) || empty($_POST['telefon'])) {
...
// nume exista
        ...
        if ($stmt = $con->prepare('INSERT INTO participant (username, nume, prenume, 
...
// Nu dorim să expunem parole în baza noastră de date, așa că hash parola și utilizați //password_verify atunci când un utilizator se conectează.
            $password = password_hash($_POST['password'],
                PASSWORD_DEFAULT);
            $stmt->bind_param('ssssss', $_POST['username'], $_POST['nume'], $_POST['prenume'], $password,
